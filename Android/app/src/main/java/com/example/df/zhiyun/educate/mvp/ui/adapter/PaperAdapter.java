...
/**
 * ================================================
 * 展示 {@link DefaultAdapter} 的用法   教学页面里的考试管理
 * <p>
 ...
 * ================================================
 */
public class PaperAdapter extends BaseQuickAdapter<TodoItem, BaseViewHolder> {
    public PaperAdapter(@Nullable List<TodoItem> data) {
    ...
    protected void convert(BaseViewHolder helper, TodoItem data) {
        ...
        TextView tvTime = helper.getView(R.id.tv_todo_time);
        tvTime.setText(TimeUtils.getMd(data.getCreateTime()));
        helper.setImageResource(R.id.iv_todo,R.mipmap.ic_list_blue_light);
        helper.setText(R.id.tv_todo_inspect,"立即阅卷")
                .setBackgroundRes(R.id.tv_todo_inspect,
                        R.drawable.shape_recangle_light_blue);
