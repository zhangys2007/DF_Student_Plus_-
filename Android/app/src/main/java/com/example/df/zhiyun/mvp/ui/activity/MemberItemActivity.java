...
import com.example.df.zhiyun.di.component.DaggerMemberItemComponent;
import com.example.df.zhiyun.mvp.contract.MemberItemContract;
import com.example.df.zhiyun.mvp.presenter.MemberItemPresenter;
 ...
 * ================================================
 */
public class MemberItemActivity extends BaseStatusActivity<MemberItemPresenter> implements MemberItemContract.View
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerMemberItemComponent //如找不到该类,请编译一下项目
                .builder()
...
//        initRecyclerView();
//        initRefreshLayout();
//        tvParent.setText(getString(R.string.member_of_grade));
    }
