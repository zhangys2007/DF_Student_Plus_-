...
import com.example.df.zhiyun.correct.mvp.model.CorrectHWcomModel;
 ...
 */
@Module
public abstract class CorrectHWcomModule {

    @Binds
    abstract CorrectHWcomContract.Model bindHWcomModel(CorrectHWcomModel model);
