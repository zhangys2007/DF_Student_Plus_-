...
import com.example.df.zhiyun.correct.di.component.DaggerCorrectHWmultComponent;
...
import com.example.df.zhiyun.correct.mvp.presenter.CorrectHWmultPresenter;
 ...
 * ================================================
 */
public class CorrectHWmultFragment extends BaseFragment<CorrectHWmultPresenter> implements CorrectHWmultContract.View, IQuestionLookup
...
//    RecyclerView.LayoutManager layoutManager;
    ...
    public static CorrectHWmultFragment newInstance(int index, int total, int nvType) {
        CorrectHWmultFragment fragment = new CorrectHWmultFragment();
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerCorrectHWmultComponent //如找不到该类,请编译一下项目
                .builder()
