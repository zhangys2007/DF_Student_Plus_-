 ...
 */
@FragmentScope
public class QuestionCompearModel extends BaseModel implements QuestionCompearContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public QuestionCompearModel(IRepositoryManager repositoryManager) {
