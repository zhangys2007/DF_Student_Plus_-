 ...
 */
@FragmentScope
public class GradeScorePercentModel extends BaseModel implements GradeScorePercentContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GradeScorePercentModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<GradePerscent>> knowledgeGrasp(int fzPaperId, int type, int gradeId, int schoolId, int subjectId) {
...
//        params.put("homeworkId", homeworkId);
        ...
        return mRepositoryManager
                ...
                .findGradeRankDistribution(ParamsUtils.fromMap(mApplication,params));
    }
}