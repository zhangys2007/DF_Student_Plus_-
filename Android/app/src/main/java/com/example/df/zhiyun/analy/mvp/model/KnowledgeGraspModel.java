 ...
 */
@FragmentScope
public class KnowledgeGraspModel extends BaseModel implements KnowledgeGraspContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public KnowledgeGraspModel(IRepositoryManager repositoryManager) {
