 ...
 * ================================================
 */
public interface GradeDetailTableContract {
    ...
    interface Model extends IModel {
        Observable<BaseResponse<List<DetailTable>>> getDetailTable( int fzPaperId, int type, int gradeId, int schoolId, int subjectId);
    }
}
