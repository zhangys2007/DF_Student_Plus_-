 ...
 */
@ActivityScope
public class ClassMemberPresenter extends BasePresenter<ClassMemberContract.Model, ClassMemberContract.View> {
    @Inject
    ...
    @Inject
    public ClassMemberPresenter(ClassMemberContract.Model model, ClassMemberContract.View rootView) {
...
//        requestData(true);
    ...
    public void requestData(boolean pullToRefresh) {
        mModel.getClassMembers(paginatorHelper.getPageIndex(pullToRefresh),classId)
