 ...
 * ================================================
 */
public interface GradeScoreLevelContract {
    ...
    interface Model extends IModel {
        Observable<BaseResponse<List<ScoreCompearLevel>>> findGradeDistribution(int fzPaperId, int type, int gradeId, int schoolId, int subjectId);
    }
}
