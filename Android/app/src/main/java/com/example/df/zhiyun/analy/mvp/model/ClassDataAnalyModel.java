 ...
 */
@ActivityScope
public class ClassDataAnalyModel extends BaseModel implements ClassDataAnalyContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ClassDataAnalyModel(IRepositoryManager repositoryManager) {
