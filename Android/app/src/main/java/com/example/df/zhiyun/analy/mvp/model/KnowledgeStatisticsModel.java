 ...
 */
@ActivityScope
public class KnowledgeStatisticsModel extends BaseModel implements KnowledgeStatisticsContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public KnowledgeStatisticsModel(IRepositoryManager repositoryManager) {
