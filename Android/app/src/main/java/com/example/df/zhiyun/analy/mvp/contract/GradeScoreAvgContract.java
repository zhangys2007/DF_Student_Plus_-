 ...
 * ================================================
 */
public interface GradeScoreAvgContract {
    ...
    interface Model extends IModel {
        Observable<BaseResponse<List<GradeAvg>>> findAverageContrast(int fzPaperId, int type, int gradeId, int schoolId, int subjectId);
    }
}
