 ...
 */
@FragmentScope
public class DetailTablePresenter extends BasePresenter<DetailTableContract.Model, DetailTableContract.View> {
    @Inject
...
//    private PaginatorHelper paginatorHelper = new PaginatorHelper();
    ...
    @Inject
    public DetailTablePresenter(DetailTableContract.Model model, DetailTableContract.View rootView) {
    ...
    public void requestData(boolean pullToRefresh) {
        mModel.getDetailTable(mHomeworkId,mFz,mType,mGradeId,mSchoolId,mSubjId)
