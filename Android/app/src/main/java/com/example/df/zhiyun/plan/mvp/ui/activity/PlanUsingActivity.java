...
import com.example.df.zhiyun.plan.di.component.DaggerPlanUsingComponent;
import com.jess.arms.di.component.AppComponent;
import com.jess.arms.utils.ArmsUtils;

import com.example.df.zhiyun.plan.mvp.contract.PlanUsingContract;
import com.example.df.zhiyun.plan.mvp.presenter.PlanUsingPresenter;
 ...
 * ================================================
 */
public class PlanUsingActivity extends BaseStatusActivity<PlanUsingPresenter> implements PlanUsingContract.View
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerPlanUsingComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_plan_using; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
