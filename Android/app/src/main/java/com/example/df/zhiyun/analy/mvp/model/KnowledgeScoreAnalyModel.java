 ...
 */
@FragmentScope
public class KnowledgeScoreAnalyModel extends BaseModel implements KnowledgeScoreAnalyContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public KnowledgeScoreAnalyModel(IRepositoryManager repositoryManager) {
