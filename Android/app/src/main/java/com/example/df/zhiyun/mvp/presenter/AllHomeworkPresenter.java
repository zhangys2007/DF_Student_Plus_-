 ...
 */
@ActivityScope
public class AllHomeworkPresenter extends BasePresenter<AllHomeworkContract.Model, AllHomeworkContract.View> {
    @Inject
    ...
    @Inject
    public AllHomeworkPresenter(AllHomeworkContract.Model model, AllHomeworkContract.View rootView) {
