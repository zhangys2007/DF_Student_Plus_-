 ...
 * ================================================
 */
public interface ClassCorrectInfoContract {
    ...
    interface View extends IView {
        ...
        String KEY_SUBJID = "subjectId";
    }

    //Model层定义接口,外部只需关心Model返回的数据,无需关心内部细节,即是否使用缓存
    interface Model extends IModel {
        Observable<BaseResponse<List<ClassCorrectInfo>>> classCorrectInfoes(int fzPaperId, int type, int  schoolId, int gradeId);
    }
}
