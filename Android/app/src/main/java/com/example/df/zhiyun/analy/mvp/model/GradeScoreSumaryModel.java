 ...
 */
@FragmentScope
public class GradeScoreSumaryModel extends BaseModel implements GradeScoreSumaryContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GradeScoreSumaryModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<ScoreCompearSumary>>> knowledgeGrasp(int fzPaperId, int type, int gradeId, int schoolId, int subjectId) {
...
//        params.put("homeworkId", homeworkId);
        ...
        return mRepositoryManager
                ...
                .findScoreOverview(ParamsUtils.fromMap(mApplication,params));
    }
}