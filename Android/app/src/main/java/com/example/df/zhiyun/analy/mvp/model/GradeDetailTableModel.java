 ...
 */
@FragmentScope
public class GradeDetailTableModel extends BaseModel implements GradeDetailTableContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GradeDetailTableModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<DetailTable>>> getDetailTable(int fzPaperId, int type, int gradeId, int schoolId, int subjectId) {
...
//        params.put("homeworkId", homeworkId);
        ...
        return mRepositoryManager
                ...
                .findTestGradePaperAnalysis(ParamsUtils.fromMap(mApplication,params));
    }
}