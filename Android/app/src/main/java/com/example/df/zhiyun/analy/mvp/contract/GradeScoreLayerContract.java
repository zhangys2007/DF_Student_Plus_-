 ...
 * ================================================
 */
public interface GradeScoreLayerContract {
    ...
    interface Model extends IModel {
        Observable<BaseResponse<List<ScoreCompearLayer>>> findArrangementContrast(int fzPaperId, int type, int gradeId, int schoolId, int subjectId);
    }
}
