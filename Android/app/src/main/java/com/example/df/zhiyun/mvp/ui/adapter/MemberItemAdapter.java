...
/**
 * ================================================
 * 展示 {@link DefaultAdapter} 的用法  老师身份下 班级成员列表
 * <p>
 ...
 * ================================================
 */
public class MemberItemAdapter extends BaseQuickAdapter<MemberItem, BaseViewHolder> {
    private String strQuote;
    private String strNoEmail;
    private ImageLoader mImageLoader;

    public MemberItemAdapter(@Nullable List<MemberItem> data) {
