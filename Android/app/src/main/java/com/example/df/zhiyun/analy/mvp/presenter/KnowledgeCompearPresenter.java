 ...
 */
@FragmentScope
public class KnowledgeCompearPresenter extends BasePresenter<KnowledgeCompearContract.Model, KnowledgeCompearContract.View> {
    @Inject
...
//    String mHomeworkId;
    ...
    @Inject
    public KnowledgeCompearPresenter(KnowledgeCompearContract.Model model, KnowledgeCompearContract.View rootView) {
    ...
    private void processData(CompearItem data){
        ...
        collumCount = 2+1+ (data.getClassList()==null?0:data.getClassList().size())*2;
