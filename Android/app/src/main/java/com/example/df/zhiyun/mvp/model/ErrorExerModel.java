 ...
 */
@FragmentScope
public class ErrorExerModel extends BaseModel implements ErrorExerContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ErrorExerModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<Question>>> getQuestion(int page,int subjectId,
        ...
        return mRepositoryManager
                ...
                .getWrongQuestions(ParamsUtils.fromMap(mApplication,params));
    }
