 ...
 */
@ActivityScope
public class ExerRecordPresenter extends BasePresenter<ExerRecordContract.Model, ExerRecordContract.View> {
    @Inject
    ...
    @Inject
    public ExerRecordPresenter(ExerRecordContract.Model model, ExerRecordContract.View rootView) {
