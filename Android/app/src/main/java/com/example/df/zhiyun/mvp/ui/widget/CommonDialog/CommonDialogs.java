package com.example.df.zhiyun.mvp.ui.widget.CommonDialog;
...
/***
 * app内的统一风格的公用弹出对话框，包括单选，确认/取消，输入，列表，底部列表
 */
...
public class CommonDialogs {
    ...
    private CommonDialogAdapter mAdapter;                     //Adapter，设配自定义的数据
    ...
    public CommonDialogs(Context context) {
        ...
        mDialogLayout = inflater.inflate(R.layout.comom_dialog_center, null);
    }
     ...
     */
    public CommonDialogs(Context context, int customAnim) {
        this(context);
     ...
     */
    public CommonDialogs(Context context, String gravity) {
        this.mContext = context;
        if (gravity.equals(BOTTOM)) {
            mIsBottomDialog = true;
        }
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mDialogLayout = inflater.inflate(R.layout.comom_dialog_bottom, null);
    }
     ...
     * @param gravity    位置，String类型，必须是"BOTTOM"才会显示底部Dialog
     */
    public CommonDialogs(Context context, int customAnim, String gravity) {
        this.mContext = context;
        if (gravity.equals(BOTTOM)) {
            mIsBottomDialog = true;
        }
     ...
     * @return this
     */
    public CommonDialogs setCancelable(Boolean boolean1) {
     ...
     * @return this
     */
    public CommonDialogs setTitle(int title) {
        mIsShowTitle = true;
     ...
     * @return this
     */
    public CommonDialogs setTitle(String title) {
        mIsShowTitle = true;
        ((TextView) mDialogLayout.findViewById(R.id.title)).setText(title);
        return this;
    }
     ...
     * @return this
     */
    public CommonDialogs setTitleSize(int size) {
     ...
     * @return this
     */
    public CommonDialogs setTitleColor(int color) {
     ...
     * @return this
     */
    public CommonDialogs setTitleStyleBold() {
     ...
     * @return this
     */
    public CommonDialogs setTitleBackgroundColor(int color) {
     ...
     * @return this
     */
    public CommonDialogs setMessage(int message) {
     ...
     * @return this
     */
    public CommonDialogs setMessage(String message) {
        ((TextView) mDialogLayout.findViewById(R.id.message)).setText(message);
        return this;
    }
     ...
     * @return this
     */
    public CommonDialogs setMessageColor(int color) {
     ...
     * @return this
     */
    public CommonDialogs setMessageBackground(int color) {
     ...
     * @return this
     */
    public CommonDialogs setNegativeButton(String negativeText, View.OnClickListener listener) {
     ...
     * @return this
     */
    public CommonDialogs setNegativeButtonColor(int color) {
     ...
     * @return this
     */
    public CommonDialogs setNegativeButtonTextSize(int size) {
     ...
     * @return this
     */
    public CommonDialogs setNegativeButtonStyleBold() {
     ...
     * @return this
     */
    public CommonDialogs setPositiveButton(String positiveText, View.OnClickListener listener) {
     ...
     * @return this
     */
    public CommonDialogs setPositiveButtonColor(int color) {
     ...
     * @return this
     */
    public CommonDialogs setPositiveButtonSize(int size) {
     ...
     * @return this
     */
    public CommonDialogs setPositiveButtonStyleBold() {
     ...
     * @return this
     */
    public CommonDialogs setView(View v) {
     ...
     * @return this
     */
    public CommonDialogs setListView(String[] data, AdapterView.OnItemClickListener listener) {
     ...
     * @return this
     */
    public CommonDialogs setListView(List<String> list, AdapterView.OnItemClickListener listener) {
        ...
        mAdapter = new CommonDialogAdapter(mContext, R.layout.comom_dialog_str_item, mDataList);
        return this;
    }
     ...
     * @return this
     */
    public CommonDialogs setListView(String[] data, Integer[] colors, AdapterView.OnItemClickListener listener) {
     ...
     * @return this
     */
    public CommonDialogs setListView(List<String> list, Integer[] colors, AdapterView.OnItemClickListener listener) {
     ...
     * @return this
     */
    public CommonDialogs setListView(String[] data, List<Integer> colors, AdapterView.OnItemClickListener listener) {
     ...
     * @return this
     */
    public CommonDialogs setListView(List<String> list, List<Integer> colors, AdapterView.OnItemClickListener listener) {
        mIsShowListView = true;
        mItemClickListener = listener;
        mDataList = new ArrayList<>();
        for (String str : list) {
        ...
        mAdapter = new CommonDialogAdapter(mContext, R.layout.comom_dialog_str_item, mDataList, colors);
        return this;
    }
     ...
     * @return this
     */
    public CommonDialogs setBottomView(View v) {
     ...
     * @return this
     */
    public CommonDialogs setBottomTitle(int title) {
     ...
     * @return this
     */
    public CommonDialogs setBottomTitle(String title) {
        mIsShowBottomTitle = true;
        ((TextView) mDialogLayout.findViewById(R.id.bottom_title)).setText(title);
        return this;
    }
     ...
     * @return this
     */
    public CommonDialogs setBottomTitleColor(int color) {
     ...
     * @return this
     */
    public CommonDialogs setBottomTitleSize(int size) {
     ...
     * @return this
     */
    public CommonDialogs setBottomTitleBackground(int color) {
        mIsShowBottomTitle = true;
     ...
     * @return this
     */
    public CommonDialogs setBottomNegativeButton(String negativeText, View.OnClickListener listener) {
     ...
     * @return this
     */
    public CommonDialogs setBottomNegativeButtonColor(int color) {
     ...
     * @return this
     */
    public CommonDialogs setBottomNegativeButtonSize(int size) {
     ...
     * @return this
     */
    public CommonDialogs setBottomNegativeButtomStyleBold() {
     ...
     * @return this
     */
    public CommonDialogs setBottomNegativeButtonBackground(int color) {
    ...
    public Dialog builder() {
        dialog = new Dialog(mContext, R.style.CcommonDialogTheme);
