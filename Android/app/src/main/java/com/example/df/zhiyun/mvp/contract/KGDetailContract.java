 ...
 * ================================================
 */
public interface KGDetailContract {
    ...
    interface Model extends IModel {
        Observable<BaseResponse<List<KnowledgeGrasp>>> knowledgeGrasp(String homeworkId, int fzPaperId, int type, int gradeId, int schoolId,int subjectId);
    }
}
