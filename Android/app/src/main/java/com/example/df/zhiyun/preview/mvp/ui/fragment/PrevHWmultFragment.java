...
import com.example.df.zhiyun.preview.di.component.DaggerPrevHWmultComponent;
...
import com.example.df.zhiyun.preview.mvp.presenter.PrevHWmultPresenter;
 ...
 * ================================================
 */
public class PrevHWmultFragment extends BaseFragment<PrevHWmultPresenter> implements PrevHWmultContract.View, IQuestionLookup {
...
//    RecyclerView.LayoutManager layoutManager;
    ...
    public static PrevHWmultFragment newInstance(int index, int total, int nvType) {
        PrevHWmultFragment fragment = new PrevHWmultFragment();
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerPrevHWmultComponent //如找不到该类,请编译一下项目
                .builder()
