 ...
 * ================================================
 */
public interface GradeScorePercentContract {
    ...
    interface Model extends IModel {
        Observable<BaseResponse<GradePerscent>> knowledgeGrasp(int fzPaperId, int type, int gradeId, int schoolId, int subjectId);
    }
}
