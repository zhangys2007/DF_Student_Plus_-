...
public class EmbedBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public EmbedBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//    }
    ...
    public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V child, @NonNull View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        ...
        int dy = dyUnconsumed;
        int realDy = dy;
//        Timber.tag("bottom").d("--------------heigt:" + child.getHeight());
//        Timber.tag("bottom").d("--------------y:" + child.getY());
        View scrollingChild = mNestedScrollingChildRef.get();
        if (target != scrollingChild) {
            return;
        }
        ...
        if (dy > 0) { // Upward
            if (newTop < mMinOffset) {
                realDy = currentTop - mMinOffset;
                ViewCompat.offsetTopAndBottom(child, -realDy);
                setStateInternal(STATE_EXPANDED);
            } else {
                realDy = dy;
                ViewCompat.offsetTopAndBottom(child, -realDy);
...
//            }
    ...
    /**
     * A utility function to get the {@link EmbedBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link EmbedBottomSheetBehavior}.
     * @return The {@link EmbedBottomSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> EmbedBottomSheetBehavior<V> from(V view) {
        ...
        return (EmbedBottomSheetBehavior<V>) behavior;
    }
