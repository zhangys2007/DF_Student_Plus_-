 ...
 */
@FragmentScope
public class GradeScoreLayerModel extends BaseModel implements GradeScoreLayerContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GradeScoreLayerModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<ScoreCompearLayer>>> findArrangementContrast(int fzPaperId, int type, int gradeId, int schoolId, int subjectId) {
...
//        params.put("subjectId", subjectId);
        ...
        return mRepositoryManager
                ...
                .findArrangementContrast(ParamsUtils.fromMap(mApplication,params));
    }
}