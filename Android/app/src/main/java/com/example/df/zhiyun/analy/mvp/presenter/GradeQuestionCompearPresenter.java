 ...
 */
@FragmentScope
public class GradeQuestionCompearPresenter extends BasePresenter<GradeQuestionCompearContract.Model, GradeQuestionCompearContract.View> {
    @Inject
...
//    String mHomeworkId;
    ...
    @Inject
    public GradeQuestionCompearPresenter(GradeQuestionCompearContract.Model model, GradeQuestionCompearContract.View rootView) {
    ...
    private void processData(CompearItem data){
        ...
        collumCount = 1+1+1+ (data.getClassList()==null?0:data.getClassList().size())*2;
