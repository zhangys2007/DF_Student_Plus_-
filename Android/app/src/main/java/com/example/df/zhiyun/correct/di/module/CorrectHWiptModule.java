...
import com.example.df.zhiyun.correct.mvp.model.CorrectHWiptModel;
 ...
 */
@Module
public abstract class CorrectHWiptModule {

    @Binds
    abstract CorrectHWiptContract.Model bindHWiptModel(CorrectHWiptModel model);
