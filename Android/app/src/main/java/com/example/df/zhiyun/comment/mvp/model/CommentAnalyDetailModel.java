 ...
 */
@ActivityScope
public class CommentAnalyDetailModel extends BaseModel implements CommentAnalyDetailContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public CommentAnalyDetailModel(IRepositoryManager repositoryManager) {
