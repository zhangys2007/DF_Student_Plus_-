...
public class MainHWRecycleViewGridDivider extends RecyclerView.ItemDecoration {
    private Paint mPaint;
    private int mDividerWidth;

    public MainHWRecycleViewGridDivider(int height, @ColorInt int color) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if(itemPosition == 0){
            ...
            outRect.set(mDividerWidth, mDividerWidth, 0, 0);
        }
    }
