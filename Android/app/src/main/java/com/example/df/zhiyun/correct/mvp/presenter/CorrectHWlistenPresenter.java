 ...
 */
@FragmentScope
public class CorrectHWlistenPresenter extends BasePresenter<CorrectHWlistenContract.Model, CorrectHWlistenContract.View> {
    @Inject
    ...
    @Inject
    public CorrectHWlistenPresenter(CorrectHWlistenContract.Model model, CorrectHWlistenContract.View rootView) {
