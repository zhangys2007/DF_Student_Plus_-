 ...
 */
@ActivityScope
public class ClassCorrectInfoPresenter extends BasePresenter<ClassCorrectInfoContract.Model, ClassCorrectInfoContract.View> {
    @Inject
...
//    private PaginatorHelper paginatorHelper = new PaginatorHelper();
    ...
    @Inject
    public ClassCorrectInfoPresenter(ClassCorrectInfoContract.Model model, ClassCorrectInfoContract.View rootView) {
...
//        requestData(true);
    ...
    public void requestData(boolean pullToRefresh) {
        mModel.classCorrectInfoes(mFz,mType,mSchoolId,mGradeId)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse<List<ClassCorrectInfo>>>(mErrorHandler) {
                    @Override
                    public void onNext(BaseResponse<List<ClassCorrectInfo>> response) {
                        if(response.isSuccess()){
                            List<ClassCorrectInfo> tempDatas = response.getData();
