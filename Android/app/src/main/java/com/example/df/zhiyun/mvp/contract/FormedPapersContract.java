 ...
 * ================================================
 */
public interface FormedPapersContract {
    ...
    interface Model extends IModel {
        Observable<BaseResponse<List<FormedPaper>>> formedPaperList(int page, String classId, int type);
        Observable<BaseResponse<List<BelongClass>>> belongClass();
        Observable<BaseResponse<String>> canclePutHW(String paperId, String classId,int type);
    }
}
