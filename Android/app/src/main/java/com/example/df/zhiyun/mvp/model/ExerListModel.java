 ...
 */
@FragmentScope
public class ExerListModel extends BaseModel implements ExerListContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ExerListModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<ExerSet>> getExer(int page, int subjectId,
        ...
        return mRepositoryManager
                ...
                .exerSets(ParamsUtils.fromMap(mApplication,params));
    }
