 ...
 */
@ActivityScope
public class CommentUsageModel extends BaseModel implements CommentUsageContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public CommentUsageModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<PlanUsage>>> goTCommentonUsageHistoryTable(String userName, Map<String,Object> gradeClassId, int type, int page) {
        ...
        return mRepositoryManager
                ...
                .goTCommentonUsageHistoryTable(ParamsUtils.fromMap(mApplication,params));
    }
