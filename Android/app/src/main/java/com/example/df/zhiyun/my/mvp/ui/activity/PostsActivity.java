...
import com.example.df.zhiyun.my.di.component.DaggerPostsComponent;
import com.jess.arms.di.component.AppComponent;
import com.jess.arms.utils.ArmsUtils;
import com.example.df.zhiyun.my.mvp.contract.PostsContract;
import com.example.df.zhiyun.my.mvp.presenter.PostsPresenter;
 ...
 * ================================================
 */
public class PostsActivity extends BaseStatusActivity<PostsPresenter> implements PostsContract.View,
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerPostsComponent //如找不到该类,请编译一下项目
                .builder()
