 ...
 */
@FragmentScope
public class GradeDetailTablePresenter extends BasePresenter<GradeDetailTableContract.Model, GradeDetailTableContract.View> {
    @Inject
...
//    private PaginatorHelper paginatorHelper = new PaginatorHelper();
    ...
    @Inject
    public GradeDetailTablePresenter(GradeDetailTableContract.Model model, GradeDetailTableContract.View rootView) {
    ...
    public void requestData(boolean pullToRefresh) {
        mModel.getDetailTable(mFz,mType,mGradeId,mSchoolId,mSubjId)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse<List<DetailTable>>>(mErrorHandler) {
                    @Override
                    public void onNext(BaseResponse<List<DetailTable>> response) {
                        if(response.isSuccess()){
                            List<DetailTable> tempDatas = response.getData();
