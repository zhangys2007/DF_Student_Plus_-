 ...
 */
@FragmentScope
public class HWsmpPresenter extends BasePresenter<HWsmpContract.Model, HWsmpContract.View> {
    @Inject
    ...
    @Inject
    public HWsmpPresenter(HWsmpContract.Model model, HWsmpContract.View rootView) {
