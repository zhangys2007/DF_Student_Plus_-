 ...
 */
@FragmentScope
public class DetailTableModel extends BaseModel implements DetailTableContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DetailTableModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<DetailTable>>> getDetailTable(String homeworkId, int fzPaperId, int type, int gradeId, int schoolId, int subjectId) {
        ...
        return mRepositoryManager
                ...
                .findTestPaperAnalysis(ParamsUtils.fromMap(mApplication,params));
    }
}