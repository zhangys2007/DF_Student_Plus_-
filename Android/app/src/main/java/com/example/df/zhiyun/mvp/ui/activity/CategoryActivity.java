...
import com.example.df.zhiyun.mvp.presenter.CategoryPresenter;

import javax.inject.Inject;
import javax.inject.Named;

import butterknife.BindView;
import com.example.df.zhiyun.di.component.DaggerCategoryComponent;
 ...
 * ================================================
 */
public class CategoryActivity extends BaseStatusActivity<CategoryPresenter> implements CategoryContract.View
    ...
    public static void startSyncExerById(Context context, String subjName){
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tv_book_name:
                break;
            case R.id.tv_switch:
                VersionSwitchActivity.startVersionSwitchPage(this,subjName,REQ_CODE);
                break;
        }
    }
...
//            SetHomeworkActivity.launchActivity(this,categoryNode.getId(),
//                    Api.STUDUNTEN_ANSWER_TYPE_SYNC,categoryNode.getSubjectId());
            SetHomeworkActivity.launchActivity(this,categoryNode.getId(),
                    "",categoryNode.getSubjectId(),"",0);
        }
    }
