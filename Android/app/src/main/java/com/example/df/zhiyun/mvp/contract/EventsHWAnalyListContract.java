 ...
 * ================================================
 */
public interface EventsHWAnalyListContract {
    ...
    interface Model extends IModel {
        ...
        Observable<BaseResponse<List<GrowthTraceItem>>> growthTraceItems(int pageNo, String subjectId, String classId);

        void parseLevel1(List<FilterGrade> data, List<String> op1, List<List<String>> op2, List<List<List<String>>> op3);
    }
}
