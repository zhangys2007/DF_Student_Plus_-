 ...
 */
@ActivityScope
public class LevelReportDetailModel extends BaseModel implements LevelReportDetailContract.Model{
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public LevelReportDetailModel(IRepositoryManager repositoryManager) {
