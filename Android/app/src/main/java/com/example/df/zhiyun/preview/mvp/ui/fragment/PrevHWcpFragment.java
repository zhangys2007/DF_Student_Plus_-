...
import com.example.df.zhiyun.preview.di.component.DaggerPrevHWcpComponent;
...
import com.example.df.zhiyun.preview.mvp.presenter.PrevHWcpPresenter;
 ...
 * ================================================
 */
public class PrevHWcpFragment extends BaseFragment<PrevHWcpPresenter> implements PrevHWcpContract.View , IQuestionLookup {
...
//    RecyclerView.LayoutManager layoutManager;
    ...
    public static PrevHWcpFragment newInstance(int index, int total,int nvType) {
        PrevHWcpFragment fragment = new PrevHWcpFragment();
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerPrevHWcpComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        if(getParentFragment() == null){  //没被嵌套，不是分屏里的小题
            new ViewLastNextInitHelper().init(this,(INavigation)getActivity(),getArguments().getInt(ViewLastNextInitHelper.KEY_NAVIGATION),true);
        }else{
            new ViewLastNextInitHelper().init(this,(INavigation)getParentFragment(),getArguments().getInt(ViewLastNextInitHelper.KEY_NAVIGATION),true);
        }
    ...
    private void initRecyclerView(Question data){
        ...
        ((PrevHWAnalyAdapter)mAdapter).setShowStudentAnswer(((PreviewHomeworkContract.View)activity).isHistoryPaper());
