 ...
 */
@FragmentScope
public class GradeScoreAvgModel extends BaseModel implements GradeScoreAvgContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GradeScoreAvgModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<GradeAvg>>> findAverageContrast(int fzPaperId, int type, int gradeId, int schoolId, int subjectId) {
...
//        params.put("subjectId", subjectId);
        ...
        return mRepositoryManager
                ...
                .findAverageContrast(ParamsUtils.fromMap(mApplication,params));
    }
}