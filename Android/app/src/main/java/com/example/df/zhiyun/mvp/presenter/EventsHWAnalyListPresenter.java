 ...
 */
@ActivityScope
public class EventsHWAnalyListPresenter extends BasePresenter<EventsHWAnalyListContract.Model, EventsHWAnalyListContract.View> {
    @Inject
    ...
    @Inject
    public EventsHWAnalyListPresenter(EventsHWAnalyListContract.Model model, EventsHWAnalyListContract.View rootView) {
    ...
    private void processFilterData(List<FilterGrade> data){
        ...
        mModel.parseLevel1(data,op1,op2,op3);
