 ...
 * ================================================
 */
public interface HistoryKnowledgePointContract {
    ...
    interface Model extends IModel {
        ...
        Observable<BaseResponse<List<HistoryKnowledgePoint>>> historyKnowledgePointsAnaly(int pageNo, String subjectId, String classId);
    }
}
