...
import com.example.df.zhiyun.correct.di.component.DaggerCorrectHWsepComponent;
...
import com.example.df.zhiyun.correct.mvp.presenter.CorrectHWsepPresenter;
 ...
 * ================================================
 */
public class CorrectHWsepFragment extends BaseFragment<CorrectHWsepPresenter> implements CorrectHWsepContract.View,View.OnClickListener
    ...
    public static CorrectHWsepFragment newInstance(int index, int total, int nvType) {
        CorrectHWsepFragment fragment = new CorrectHWsepFragment();
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerCorrectHWsepComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_correct_sep, container, false);
    }
