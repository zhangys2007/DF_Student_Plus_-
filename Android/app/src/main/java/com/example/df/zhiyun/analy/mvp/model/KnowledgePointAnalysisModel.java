 ...
 */
@ActivityScope
public class KnowledgePointAnalysisModel extends BaseModel implements KnowledgePointAnalysisContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public KnowledgePointAnalysisModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<PointAnalysis>>> pointAnalysis(String knowledgeId,String createTime,String classId,int subjectId) {
        ...
        return mRepositoryManager
                ...
                .pointAnalysis(ParamsUtils.fromMap(mApplication,params));
    }
}