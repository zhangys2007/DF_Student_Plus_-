...
import com.example.df.zhiyun.organize.di.component.DaggerGradeItemComponent;
...
import com.example.df.zhiyun.organize.mvp.presenter.GradeItemPresenter;
 ...
 * ================================================
 */
public class GradeItemActivity extends BaseStatusActivity<GradeItemPresenter> implements GradeItemContract.View
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerGradeItemComponent //如找不到该类,请编译一下项目
                .builder()
...
//        initRecyclerView();
//        initRefreshLayout();
//        tvParent.setText(getString(R.string.my_school));
    }
    ...
    private void initRecyclerView(){
        ...
        View head = LayoutInflater.from(this).inflate(R.layout.view_school_head,null);
        ((TextView)head.findViewById(R.id.tv_sch_name)).setText(mSchoolName);
...
//    }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        GradeItem item = (GradeItem)adapter.getData().get(position);
        if(item.getIsGrade() == 1){
            Intent intent = new Intent(this, ClassItemActivity.class);
            intent.putExtra(ClassItemContract.View.KEY,item.getGradeNumber());
            intent.putExtra(ClassItemContract.View.Name,item.getGradeName());
