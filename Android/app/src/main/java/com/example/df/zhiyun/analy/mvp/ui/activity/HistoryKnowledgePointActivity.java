...
import com.example.df.zhiyun.analy.di.component.DaggerHistoryKnowledgePointComponent;
 ...
 * ================================================
 */
public class HistoryKnowledgePointActivity extends BaseStatusActivity<HistoryKnowledgePointPresenter> implements HistoryKnowledgePointContract.View
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerHistoryKnowledgePointComponent //如找不到该类,请编译一下项目
                .builder()
...
//        mAdapter.setLoadMoreView(new ListLoadmoreView()); //自定义的loadmoreview
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        HistoryKnowledgePoint data = (HistoryKnowledgePoint)adapter.getData().get(position);
...
//            GrowthTraceActivity.launchActivity(this,data,mPresenter.getSubjectID(),tvSubject.getText().toString());
            KnowledgePointAnalysisActivity.launcheDetailActivity(this,data.getKnowledge(),data.getSubjectId(),data.getClassId()
            ,data.getTime(),data.getKnowledgeId());
        }
    }
