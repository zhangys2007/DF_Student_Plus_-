 ...
 * ================================================
 */
public interface GradeScoreSumaryContract {
    ...
    interface Model extends IModel {
        Observable<BaseResponse<List<ScoreCompearSumary>>> knowledgeGrasp(int fzPaperId, int type, int gradeId, int schoolId, int subjectId);
    }
}
