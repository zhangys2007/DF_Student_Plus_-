...
public class MarkerViewGrowthClass extends MarkerView {
    ...
    public MarkerViewGrowthClass(Context context, int layoutResource) {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ClassImprove point = (ClassImprove)e.getData();
        tvPaperName.setText(point.getHomework_name());
        tvScoreMy.setText(StringCocatUtil.concat("标准差：","--"));

        tvScoreMy.setVisibility(View.GONE);
        LinearLayout.LayoutParams layoutParams =(LinearLayout.LayoutParams) tvScoreAvg.getLayoutParams();
