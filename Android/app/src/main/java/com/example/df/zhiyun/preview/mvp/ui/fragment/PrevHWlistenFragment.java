...
import com.example.df.zhiyun.preview.di.component.DaggerPrevHWlistenComponent;
 ...
 * ================================================
 */
public class PrevHWlistenFragment extends BaseFragment<PrevHWlistenPresenter> implements PrevHWlistenContract.View
    ...
    public static PrevHWlistenFragment newInstance(int index, int total, int nvType) {
        PrevHWlistenFragment fragment = new PrevHWlistenFragment();
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerPrevHWlistenComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    private void initMideoPlayer(){
        String baseUrl = ((PreviewHomeworkContract.View)getActivity()).getListenerBaseUrl();
        if(baseUrl != null){
