...
import com.example.df.zhiyun.paper.di.component.DaggerHWselComponent;
...
import com.example.df.zhiyun.paper.mvp.presenter.HWselPresenter;
 ...
 * ================================================
 */
public class HWselFragment extends BaseFragment<HWselPresenter> implements HWselContract.View, DoHomeworkContract , IQuestionLookup {
...
//    RecyclerView.LayoutManager layoutManager;
    ...
    public static HWselFragment newInstance(int index, int total, int nvType) {
        HWselFragment fragment = new HWselFragment();
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerHWselComponent //如找不到该类,请编译一下项目
                .builder()
...
//            tvSteam.setText(RichTextViewHelper.ToDBC(data.getQuestionStem()));
        ...
        RichTextViewHelper.setContent(tvName,
    ...
    public void initeWhiteAnswer(Answer answer) {
        ...
        ((HWselAdapter)mAdapter).initWithAnswer(answer);
    }

    @Override
    public Answer getAnswer() {
        Answer answer = ((HWselAdapter)mAdapter).getAnswer();
