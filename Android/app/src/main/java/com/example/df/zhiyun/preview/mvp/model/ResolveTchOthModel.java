 ...
 */
@FragmentScope
public class ResolveTchOthModel extends BaseModel implements ResolveTchOthContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ResolveTchOthModel(IRepositoryManager repositoryManager) {
