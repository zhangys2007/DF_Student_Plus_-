...
import com.example.df.zhiyun.analy.di.component.DaggerKnowledgeGraspComponent;
 ...
 * ================================================
 */
public class KnowledgeGraspFragment extends BaseFragment<KnowledgeGraspPresenter> implements KnowledgeGraspContract.View{
    @Inject
    ...
    public static KnowledgeGraspFragment newInstance(int fzId,int gradeId,String hwId,int schoolId,int subjId,int type) {
        KnowledgeGraspFragment fragment = new KnowledgeGraspFragment();
        Bundle data = new Bundle();
        data.putInt(KnowledgeGraspContract.View.KEY_FZ,fzId);
        data.putInt(KnowledgeGraspContract.View.KEY_GRADEID,gradeId);
        data.putString(KnowledgeGraspContract.View.KEY_HOMEWORK_ID,hwId);
        data.putInt(KnowledgeGraspContract.View.KEY_SCHOOLID,schoolId);
        data.putInt(KnowledgeGraspContract.View.KEY_SUBJID,subjId);
        data.putInt(KnowledgeGraspContract.View.KEY_TYPE,type);
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerKnowledgeGraspComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public void initViewPager() {
        fragmentList.clear();
        fragmentList.add(KGDetailFragment.newInstance(mFz,mGradeId,mHomeworkId,mSchoolId,mSubjId,mType));
        fragmentList.add(DetailTableFragment.newInstance(mFz,mGradeId,mHomeworkId,mSchoolId,mSubjId,mType));
