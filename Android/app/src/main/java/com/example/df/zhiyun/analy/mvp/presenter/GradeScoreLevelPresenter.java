 ...
 */
@FragmentScope
public class GradeScoreLevelPresenter extends BasePresenter<GradeScoreLevelContract.Model, GradeScoreLevelContract.View> {
    @Inject
...
//    private PaginatorHelper paginatorHelper = new PaginatorHelper();
    ...
    @Inject
    public GradeScoreLevelPresenter(GradeScoreLevelContract.Model model, GradeScoreLevelContract.View rootView) {
    ...
    public void requestData(boolean pullToRefresh) {
        mModel.findGradeDistribution(mFz,mType,mGradeId,mSchoolId,mSubjId)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse<List<ScoreCompearLevel>>>(mErrorHandler) {
                    @Override
                    public void onNext(BaseResponse<List<ScoreCompearLevel>> response) {
                        if(response.isSuccess()){
                            List<ScoreCompearLevel> tempDatas = response.getData();
