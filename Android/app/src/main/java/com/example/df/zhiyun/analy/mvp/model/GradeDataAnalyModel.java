 ...
 */
@ActivityScope
public class GradeDataAnalyModel extends BaseModel implements GradeDataAnalyContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GradeDataAnalyModel(IRepositoryManager repositoryManager) {
