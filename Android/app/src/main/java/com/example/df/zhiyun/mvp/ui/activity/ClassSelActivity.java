...
import com.example.df.zhiyun.di.component.DaggerClassSelComponent;
...
import com.example.df.zhiyun.mvp.presenter.ClassSelPresenter;
 ...
 * ================================================
 */
public class ClassSelActivity extends BaseStatusActivity<ClassSelPresenter> implements ClassSelContract.View
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerClassSelComponent //如找不到该类,请编译一下项目
                .builder()
