...
import com.example.df.zhiyun.correct.mvp.model.CorrectHWmultModel;
 ...
 */
@Module
public abstract class CorrectHWmultModule {

    @Binds
    abstract CorrectHWmultContract.Model bindHWmultModel(CorrectHWmultModel model);

    @FragmentScope
    @Provides
    static RecyclerView.ItemDecoration provideItemDecoration(CorrectHWmultContract.View view) {
