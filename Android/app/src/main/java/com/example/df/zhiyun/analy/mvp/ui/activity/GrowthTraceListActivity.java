...
import com.example.df.zhiyun.analy.di.component.DaggerGrowthTraceListComponent;
...
import com.example.df.zhiyun.analy.mvp.presenter.GrowthTraceListPresenter;
 ...
 * ================================================
 */
public class GrowthTraceListActivity extends BaseStatusActivity<GrowthTraceListPresenter> implements GrowthTraceListContract.View
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerGrowthTraceListComponent //如找不到该类,请编译一下项目
                .builder()
