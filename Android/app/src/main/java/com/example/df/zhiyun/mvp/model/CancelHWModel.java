 ...
 */
@ActivityScope
public class CancelHWModel extends BaseModel implements CancelHWContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public CancelHWModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<String>> cancelHomework(String paperId,String classId,int type) {
        Map<String,Object> params = new HashMap<>();
        params.put("paperId",paperId);
