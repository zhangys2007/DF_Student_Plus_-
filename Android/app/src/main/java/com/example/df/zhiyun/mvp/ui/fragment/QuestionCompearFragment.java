...
import com.example.df.zhiyun.di.component.DaggerQuestionCompearComponent;
...
import com.example.df.zhiyun.mvp.presenter.QuestionCompearPresenter;
 ...
 * ================================================
 */
public class QuestionCompearFragment extends BaseFragment<QuestionCompearPresenter> implements QuestionCompearContract.View, CustomAdapt {
    ...
    public static QuestionCompearFragment newInstance(int fzId, int gradeId, String hwId, int schoolId, int subjId, int type) {
        QuestionCompearFragment fragment = new QuestionCompearFragment();
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerQuestionCompearComponent //如找不到该类,请编译一下项目
                .builder()
